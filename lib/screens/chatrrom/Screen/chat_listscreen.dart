...
import 'package:innovator/screens/chatrrom/Screen/chatlist_controller.dart';
                                ...
                                return Obx(() {
                                  ...
                                  return Container(
                                    decoration: BoxDecoration(
                                      color: isRecent ? Colors.orange.withOpacity(0.15) : hasUnread ? Colors.orange.withOpacity(0.15) : null,
                                          ...
                                          children: [
                                            Expanded(
                                              child: Text(
                                                displayName,
                                                style: TextStyle(
                                                  fontWeight: hasUnread || isRecent ? FontWeight.bold : FontWeight.normal,
                                                ),
                                            ...
                                            if (chat['lastMessage']?['timestamp'] != null)
                                              Text(
                                                controller.formatMessageTime(chat['lastMessage']['timestamp']),
                                                style: TextStyle(
                                                  fontSize: 12,
                                                  color: hasUnread || isRecent ? Colors.black87 : Colors.grey,
                                                  fontWeight: hasUnread || isRecent ? FontWeight.bold : FontWeight.normal,
                                                ),
                                              ),
                                          ],
